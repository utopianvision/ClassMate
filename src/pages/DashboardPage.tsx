      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2">
          <Card>
            ...
            {upcomingAssignments.length > 0 ? <div className="space-y-3">
                {upcomingAssignments.map(assignment => <UpcomingCard key={assignment.id} assignment={assignment} />)}
        ...
        <div className="space-y-6">
          <Card>
            ...
            <div className="space-y-2">
              <button className="w-full text-left p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg hover:shadow-md transition-shadow duration-200">
